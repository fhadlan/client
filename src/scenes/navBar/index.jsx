...
const NavBar = () => {
  ...
  const user = useSelector((state) => state.user); //USE SELECTOR UNTUK MENGAMBIL DATA PADA STATE INDEXJS
  const isNonMobileScreens = useMediaQuery("(min-width:1000px)");

  //SETTING VARIBALE WARNA DARI THEME.JS
